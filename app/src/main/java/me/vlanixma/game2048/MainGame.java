...
public class MainGame {
    ...
    private void initSoundPool() {
        ...
        spMap.put(1, soudPool.load(mView.getContext(), R.raw.sfx_wing, 1));
        spMap.put(2, soudPool.load(mView.getContext(), R.raw.sfx_point, 1));
        // point
        spMap.put(3, soudPool.load(mView.getContext(), R.raw.sfx_swooshing, 1));
        spMap.put(4, soudPool.load(mView.getContext(), R.raw.die, 1));
        spMap.put(5, soudPool.load(mView.getContext(), R.raw.win, 1));
    }
}